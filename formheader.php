<head>
	...
	<link rel="stylesheet" href="starkform.css">
	<link rel="stylesheet" href="foot.css">
	<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css"/>
	<script src="https://cdn.jsdelivr.net/npm/jquery@3.6.0/dist/jquery.slim.min.js"></script>
	<script src="https://cdn.jsdelivr.net/npm/popper.js@1.16.1/dist/umd/popper.min.js"></script>
	<script src="https://cdn.jsdelivr.net/npm/bootstrap@4.6.1/dist/js/bootstrap.bundle.min.js"></script>
	<script type="text/javascript" src="js/formic.js"></script>
	<script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-datepicker/1.4.1/js/bootstrap-datepicker.min.js"></script>
	<title>STARK Industries</title>
</head>
<body style="background-color: #FCCD12;">
	<header>
			<nav class="navbar navbar-expand-sm navbar-dark navstyle fixed-top" id="rcorners2" style="padding-bottom: 15px;">
			<a class="navbar-brand" href="#">
			    <img src="jarvis2.png" width="50" height="50" class="d-inline-block align-top" alt="">
			 </a>
			 <h3 class="page"><u>STARK INDUSTRIES</u></h3>
			 <div class="container" style="width:75%;padding-left: 29%;">
			 	 <div class="collapse navbar-collapse" id="navbarSupportedContent">
			 	     <ul class="navbar-nav mr-auto">
			 	       <li class="nav-item active">
			 	         <a class="nav-link menu" href="newwebp.php" style="margin-left: 1rem;" target="_blank">HOME <span class="sr-only">(current)</span></a>
			 	       </li>
			 	       <li class="nav-item active">
