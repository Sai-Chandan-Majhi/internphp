	...
	<div class="container" style="margin-top: 5rem;">
			<div class="row">
				<div class="col-sm-8 col-md-6 offset-sm-2 offset-md-3">
					<form class="register-form form-group" enctype="multipart/form-data" id="rform" method="post" action="<?php
					if(is_numeric($student_id)) echo "updatestudents.php";
					else echo "insertstudents.php";?>" name="rform">
						<h2 class="text-center" style="color: #b30e16; background-color: whitesmoke;font-family: Marvel;">STUDENT REGISTRATION</h2>
						<hr>
						<?php
						...
						<div class="row">
							...
							<div class="col-sm-10 input-container">
								<i class="fa fa-camera icon" style="padding: 15px;"></i>
